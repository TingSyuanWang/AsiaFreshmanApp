    ...
    return (
        <ScrollView style={ ViewContainer }>
            ...
            <View style={ ViewSubContainer }>
                <Text style={ ItemTitleH3 }>(一)考選部舉辦之國家公務人員考試。</Text>
                <Text style={ ItemTitleH3 }>(二)考選部舉辦之專門職業及技術人員考試。</Text>
                <Text style={ ItemTitleH3 }>(三)各學系國際專業證照。</Text>
                <Text style={ ItemTitleH3 }>(四)各學系專業暨進階證照。</Text>
            ...
            <View style={ ViewSubContainer }>
                <Text style={ ItemTitleH3 }>為使品牌企業實習學生能夠順利銜接職場實習</Text>
                ...
                <Text style={ ItemTitleH3 }>(二)前往品牌企業實習前，完成下列課程與條件：</Text>
