        ...
        return (
            <ScrollView style={ ViewContainer }>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ MainContent }>(1) 104學年度起本校講授(一)為現場授課3小時及e化教學(臺北e大)，如果僅持臺北e大學習證明抵免講授(一)恕不同意抵免。</Text>
                    <Text style={ MainContent }>(2)持臺北e大學習證明者需同時檢具志願服務特殊訓練結業證書或志願服務紀錄冊影本，同時申請講授(一)(二)抵免，始可受理申請。</Text>
                    <Text style={ ItemTitleH3 }>服務與學習（二）－講授課	</Text>
                    <Text style={ ItemTitleH3 }>一、需參加亞洲大學或其他校外單位所開辦之特殊訓練課程，並取得「特殊訓練結業證書(需滿12小時)」或「志願服務紀錄冊」，即可提出抵免申請。</Text>
                    <Text style={ ItemTitleH3 }>二、亦可提前於上學期修完基礎訓練課程領有結業證書後，於下學期開學前參加校內外各相關單位辦理之特殊訓練，檢附「結業證書」(需滿12小時)或「志願服務紀錄冊」後後即可抵免。</Text>
                </View>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ MainContent }>(1)104學年度起本校講授(一)為現場授課3小時及e化教學(臺北e大)，如果僅持臺北e大學習證明抵免講授(一)恕不同意抵免</Text>
                    <Text style={ MainContent }>(2)持臺北e大學習證明者需同時檢具志願服務特殊訓練結業證書(需滿12小時)或志願服務紀錄冊影本，同時申請講授(一)(二)抵免，始可受理申請。</Text>
