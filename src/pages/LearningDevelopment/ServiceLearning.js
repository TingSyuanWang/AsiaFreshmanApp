...
class ServiceLearning extends Component {
    ...
    render () {
        const { ViewContainer, ViewSubContainer, MainContent, ItemTitleH1, ItemTitleH2, ItemTitleH3, DividerShort, DividerLong, ImageStyle10, ItemTitleH4, ImageStyle11, ImageStyle12, ImageStyle13, ImageStyle14, ImageStyle15, ImageStyle16, ImageStyle17, ImageStyle18, ImageStyle19, ImageStyle20, MainContentRed} = customStyles;

        return (
            <ScrollView style={ ViewContainer }>
                <Text style={ ItemTitleH1 }>一、為什麼會有「服務與學習課程」？</Text>
                <View style={ ViewSubContainer }>
                    <Text style={ ItemTitleH2 }>課程目的：</Text>
                    <Text style={ ItemTitleH3 }>{'\t'}讓學生於服務過程中學習關懷的精神，並以「做中學、學中做」中，培養良好的品格及愛校盡責的價值觀，成為健全優良的「三品」人。</Text>
                    <Text style={ ItemTitleH2 }>實施對象：</Text>
                    <Text style={ ItemTitleH3 }>{'\t'}大學日間部學制之學生。【含大一生、轉學(系)生、重修生、復學生】</Text>
                </View>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ MainContentRed }>備註:不可退選可停修</Text>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ ItemTitleH3 }>服務與學習（一）－實作課 </Text>
                    <Text style={ ItemTitleH4 }>{'\t'}若曾於他校已修畢類似課程且成績及格，持有原學校成績證明者，即可提出抵免申請。</Text>
                    <Text style={ ItemTitleH3 }>服務與學習（二）－實作課</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}若曾於他校已修畢類似課程且成績及格，持有原學校成績證明者，即可提出抵免申請。</Text>
                    <Text style={ ItemTitleH3 }>服務與學習（一）－講授課</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}需參加亞洲大學或其他校外單位所開辦之基礎訓練課程，並取得「基礎訓練結業證書」，即可提出抵免申請。</Text>
                    <Text style={ MainContent }>{'\t'}104學年度起本校講授(一)為現場授課3小時及e化教學(臺北e大)，如果僅持臺北e大學習證明抵免講授(一)恕不同意抵免。</Text>
                    <Text style={ MainContent }>{'\t'}持臺北e大學習證明者需同時檢具志願服務特殊訓練結業證書或志願服務紀錄冊影本，同時申請講授(一)(二)抵免，始可受理申請。</Text>
                    <Text style={ ItemTitleH3 }>服務與學習（二）－講授課	</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}需參加亞洲大學或其他校外單位所開辦之特殊訓練課程，並取得「特殊訓練結業證書(需滿12小時)」或「志願服務紀錄冊」，即可提出抵免申請。</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}亦可提前於上學期修完基礎訓練課程領有結業證書後，於下學期開學前參加校內外各相關單位辦理之特殊訓練，檢附「結業證書」(需滿12小時)或「志願服務紀錄冊」後後即可抵免。</Text>
                </View>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ ItemTitleH3 }>申請規定：</Text>
                    <Text style={ ItemTitleH3 }>{'\t'}於「欲重修學期」之開學初，依教務處公告加退選期間自行選課。</Text>
                    <Text style={ MainContentRed }>***  實作課重修申請時程皆為每學期第7-11週  ***</Text>
                </View>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ MainContentRed }>註：上課時段將依當學年度課程規劃開設。</Text>
                    ...
                    <Text style={ MainContentRed }>～～上述事項如有未盡事宜則另行修訂～～</Text>
                </View>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ ItemTitleH3 }>(一)申請資格：</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}該學期修課學生</Text>
                    <Text style={ ItemTitleH3 }>(二)服務單位：</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}校外政府合法立案之機關、機構、法人等可提供志工服務之單位，且需經服務學習組審核通過始可。</Text>
                    <Text style={ ItemTitleH3 }>(三)	施行時程：</Text>
                    <Text style={ MainContent }>(1)辦理申請時程：當學期開學前1個月至開學後第1週止。</Text>
                    <Text style={ MainContent }>(2)公告審核結果：開學後第3週。(公佈於服務學習組網站或公布欄)</Text>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ ItemTitleH3 }>(一)申請資格：</Text>
                    <Text style={ ItemTitleH4 }>{'\t'}凡已領取校內、外志願服務運用單位核發之｢志願服務基礎訓練｣、｢志願服務特殊訓練｣結業證書或｢志願服務紀錄冊｣者。</Text>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ MainContentRed }>註：若對以上操作步驟有不清楚者，歡迎洽所屬小隊長或至課服組辦公室(A118)洽詢。</Text>
                </View>
