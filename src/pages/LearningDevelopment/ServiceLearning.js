    ...
    render () {
        ...
        return (
            <ScrollView style={ ViewContainer }>
                ...
                <Text style={ ItemTitleH1 }>二、那「服務與學習課程」包含那些課程內容？</Text>
                <View style={ ViewSubContainer }>
                ...
                <View style={ ViewSubContainer }>
                    <Text style={ ItemTitleH2 }>辦理時程：將依教務處公告之抵免作業及時程配合辦理。</Text>
                    <Text style={ ItemTitleH2 }>辦理資格：</Text>
                    ...
                    <Text style={ MainContent }>二、亦可提前於上學期修完基礎訓練課程領有結業證書後，於下學期開學前參加校內外各相關單位辦理之特殊訓練，檢附「結業證書」或「志願服務紀錄冊」後後即可抵免。</Text>
                ...
                <View style={ ViewSubContainer }>
                    ...
                    <Text style={ ItemTitleH2 }>何潔予助理分機：3291（業務範疇：負責服務與學習－實作課及服學幹部業務）</Text>
                    <Text style={ ItemTitleH2 }>詹喬羽助理分機：3292 （業務範疇：負責服務與學習－講授課及志工大學業務）</Text>
                </View>
            </ScrollView>
        );
    }
