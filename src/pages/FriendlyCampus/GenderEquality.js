        ...
        return (
            <ScrollView style={ ViewContainer }>
                ...
                <View style={ ViewContainer }>
                    ...
                    <Button buttonStyle={{ marginTop: 10, marginBottom: 10 }} icon={{name: 'account-balance'}} backgroundColor="#228B22" title='教育部性別平等教育全球資訊網' onPress={ ()=>{ Linking.openURL('https://www.gender.edu.tw/web/index.php/home')}} />
                    ...
                    <Button buttonStyle={{ marginTop: 10, marginBottom: 10 }} icon={{name: 'account-balance'}} backgroundColor="#228B22" title='亞洲大學性別平等教育委員會' onPress={ ()=>{ Linking.openURL('http://geec.asia.edu.tw/')}} />
                </View>
            </ScrollView>
        );
    }
