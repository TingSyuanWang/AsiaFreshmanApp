        ...
        return (
            <ScrollView style={ViewContainer }>
                <View style={ ViewSubContainerNoBorder }>
                    ...
                    <Text style={ ItemTitleH2 }>一、	健康中心為服務同學，於107年9月10日(一)至9月15日(六)安排合格特約醫院到校內進行健康檢查(詳細健檢時間及注意事項將於開學後另行通知並公告於健康中心網頁)，健檢費用為新台幣600元整，請於健檢當天現場繳費。</Text>
                    ...
                    <Text style={ ItemTitleH3 }>(四)須於開學後一個月內(107年10月9日)將檢查後醫院蓋章之「學生健康檢查資料卡」繳交至健康中心(管理大樓，M111室)。醫院檢查結果通常需一星期工作天，故請盡早完成健康檢查，以利於規定期限內繳交。</Text>
                    <Text style={ ItemTitleH2 }>四、	四、	校內轉系轉學生，請至「健康中心」提供原就讀學系和學號等資料，經確認已做過健康檢查者可直接資料轉移；校外轉入轉學生可向原大學申請「健康檢查資料卡」，檢查項目需符合亞洲大學「學生健康檢查資料卡」上規定項目【請撕下新生入學手冊之附件「學生健康檢查資料卡」，填妥資料卡上正面自填所有欄位，貼上2吋照片1張，連同原大學之「健康檢查資料卡」一同繳交至健康中心】。</Text>
