...
class SchoolLoan extends Component {
    ...
    render () {
        const { ViewContainer, ViewSubContainer, MainContent, ItemTitleH1, ItemTitleH2, ItemTitleH3,ImageStyle5 } = customStyles;

        return (
            <ScrollView style={ ViewContainer }>
                <Text style={ ItemTitleH2 }>就貸辦理期間：第一學期為每年8月1日開始辦理；第二學期為每年1月15日開始辦理；受理時間至規定註冊繳費日止，逾期不受理。</Text>
                <Text style={ ItemTitleH2 }>第一階段：請同學於每學期註冊繳費日前將台灣銀行申請撥款通知書（第二聯學校存執聯）親自或以掛號郵寄回生輔組；請同學依相關規定辦理，以免影響就學貸款權益。就學貸款流程圖：</Text>
                <Image style={ ImageStyle5 } resizeMode={'stretch'} source={require('../../img/flowchart.png')} />
                <Text style={ ItemTitleH2 }>第二階段：財稅中心查核年收入需繳回相關資料時間；第一學期每年約10月底；第二學期每年約4月。</Text>
