    ...
    render () {
        ...
        return (
            <ScrollView style={ ViewContainer }>
                ...
                <Text style={ ItemTitleH2 }>協助對象</Text>
                <View style={ ViewSubContainer }>
                    <Text style={ ItemTitleH3 }>具本校學籍並符合相關弱勢身分學生，包括：</Text>
                    <Text style={ ItemTitleH3 }>1.低收入戶學生</Text>
                    <Text style={ ItemTitleH3 }>2.中低收入戶學生</Text>
                    <Text style={ ItemTitleH3 }>3.身心障礙學生及身心障礙人士子女</Text>
                    <Text style={ ItemTitleH3 }>4.特殊境遇家庭子女孫子女學生</Text>
                    <Text style={ ItemTitleH3 }>5.原住民學生學雜費減免資格</Text>
                    <Text style={ ItemTitleH3 }>6.獲教育部弱勢學生助學計畫補助學生</Text>
                    <Text style={ ItemTitleH3 }>7.不同教育資歷且入大學機會較少之弱勢學生（三代家庭第1位上大學者、新住民）
                    </Text>
                </View>
             </ScrollView>
        );
